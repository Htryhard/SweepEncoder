...
import com.xiaopao.sweepencoder.qrcode.camera.CameraManager;
import com.xiaopao.sweepencoder.qrcode.camera.PreviewFrameShotListener;
import com.xiaopao.sweepencoder.qrcode.camera.Size;
import com.xiaopao.sweepencoder.qrcode.decode.DecodeListener;
import com.xiaopao.sweepencoder.qrcode.decode.DecodeThread;
import com.xiaopao.sweepencoder.qrcode.decode.LuminanceSource;
import com.xiaopao.sweepencoder.qrcode.decode.PlanarYUVLuminanceSource;
import com.xiaopao.sweepencoder.qrcode.decode.RGBLuminanceSource;
import com.xiaopao.sweepencoder.qrcode.util.DocumentUtil;
import com.xiaopao.sweepencoder.qrcode.view.CaptureView;
...
//        finish();
        Intent resultData = new Intent(CaptureActivity.this, ResultActivity.class);
        resultData.putExtra(EXTRA_RESULT, result.getText());
        resultData.putExtra(EXTRA_BITMAP, bitmap);
